...
class CampionatiAdapter(
    val context: Context,
    val campionati: List<Campionati>?,
    val campionatiListener: CampionatiListener
) : RecyclerView.Adapter<CampionatiAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, index: Int) {
        ...
        with(holder) {
            if (campionato != null) {
                name.text = campionato.nome.toUpperCase(Locale.ROOT)
